  ...
  methods: {
    bootstrapColor(colorName) {
      return {
        ["bg-" + colorName]: true,
        "text-white":
          ["white", "light", "light-grey"].includes(colorName) === false,
    ...
    grayColor(key) {
      return {
        ["bg-grey-" + key]: true,
        "text-white":
          ["100", "200", "300", "400", "500"].includes(key) === false,
