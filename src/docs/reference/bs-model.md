::: lead
**Vue MDBootstrap** provides built-in data model for working with entity object and remote API.
...
Using model to define a set of fields that represents an entity object.
...
let user = new BsModel({
  ...
  csrfConfig: {
    url: './api/token/{name}',
    // use any name to identify the token. 
    // This name is used by the RESTful backend to create the CSRF token.
...
* <span class="text-primary font-weight-bold">proxy</span> : <em class="text-grey-500">ProxyAdapter</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the proxy adapter that is used to work with RESTful backend.
...
* <span class="text-primary font-weight-bold">csrfConfig</span> : <em class="text-grey-500">Object</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the CSRF configuration that is used when instantiate the Model.
...
* <span class="text-primary font-weight-bold">restUrl</span> : <em class="text-grey-500">Object</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the REST Url configuration that is used when instantiate the Model.
...
* <span class="text-primary font-weight-bold">loading</span> : <em class="text-grey-500">Boolean</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the Model state, whether it is loading data or not.
...
* <span class="text-primary font-weight-bold">updating</span> : <em class="text-grey-500">Boolean</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the Model state, whether it is saving/updating data to the remote server or not.
...
* <span class="text-primary font-weight-bold">deleting</span> : <em class="text-grey-500">Boolean</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the Model state, whether it is deleting data or not.
...
* <span class="text-primary font-weight-bold">hasError</span> : <em class="text-grey-500">Boolean</em> <bs-badge variant="secondary">READONLY</bs-badge>
  ...
  Returns the Model state, whether there was an error when loading/saving/deleting data or not.
...
* <span class="text-primary font-weight-bold">request</span>(`String` name, `String` method, `Object` [params], `Object` [data], `Function` [successCallback], `Function` [errorCallback]) : <em class="text-grey-500">Promise</em>
